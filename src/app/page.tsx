          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="/casecanvas.png" className="w-full"/>
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight
               text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                ...
                <p className="mt-8 text:lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                  Show off your favourite pictures with your own <span className="font-semibold">1 of 1 </span>
                  phone case. CustomCase allows you to customize your case however you want by uploading your own images.
                </p>
                <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                  ...
                  <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    ...
                    <div className="flex flex-col justify-between items-center sm:items-start">
                      ...
                      <p><span className="font-semibold">1,000+</span> happy customers
                      </p>
                    </div>
                  </div>
            </div>
